# @dscvr-one/canvas-solana-adapter
...
```bash
npm install @dscvr-one/canvas-solana-adapter
```

yarn

```bash
yarn add @dscvr-one/canvas-solana-adapter
```
...
import {
  CanvasInterface,
  CanvasClient,
} from '@dscvr-one/canvas-solana-adapter';
```
